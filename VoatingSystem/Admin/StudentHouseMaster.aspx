<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Staff.Master" AutoEventWireup="true" CodeBehind="StudentHouseMaster.aspx.cs" Inherits="VoatingSystem.Admin.StudentHouseMaster" %>
                    ...
                    loadData: function (filter) {
                        return $.grep(Data, function (student) {
                            return (!filter.Stud_Key || student.Stud_Key.toLowerCase().indexOf(filter.Stud_Key.toLowerCase()) > -1)
                                ...
                                && (!filter.Stud_HouseName || student.Stud_HouseName.toLowerCase().indexOf(filter.Stud_HouseName.toLowerCase()) > -1)
                        });
                    }
                },
                fields: [
                    ...
                    { name: "Stud_HouseName", type: "text", sorting: true, title: "House"  },
