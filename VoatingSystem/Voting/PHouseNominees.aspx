<%@ Page Title="" Language="C#" MasterPageFile="~/Voting/Voating.Master" AutoEventWireup="true" CodeBehind="PHouseNominees.aspx.cs" Inherits="VoatingSystem.Voting.PHouseNominees" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <div class="chart-title">Prithvi House Election</div>
    </div>
