<%@ Page Title="" MaintainScrollPositionOnPostback="true" Language="C#" MasterPageFile="~/Voting/Voating.Master" AutoEventWireup="true" CodeBehind="AHouseNominees.aspx.cs" Inherits="VoatingSystem.Voting.AHouseNominees" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <div class="chart-title">Agni House Election</div>
    </div>
    ...
    <div class="HeadBoyRow">
            ...
            <div class="senate-con">
                ...
                <div id="prefect-vote" class="senate-vote"><a href="javascript:void(0);" onclick="javascript:TINY.box.show({url:'Voteted.aspx?id=<%=nom.Nom_Key.ToString()%>&electtype=h&columnname=<%=VoatingSystem.Business.Constants.ProcedureConstant.PR %>',post:'id=<%=nom.Nom_Key.ToString()%>',width:300,height:200,opacity:20,topsplit:2,closejs:function(){closeJS()}})"">VOTE</a></div>
